!function(e, t) {
    ...
    return function(e) {
        ...
        this.add = function(e) {
            ...
            o = 0; o < t.length; o++)
                if (this.hasAnchorJSLink(t[o]))
                    d.push(o);
                else {
                    if (t[o].hasAttribute("id"))
                        i = t[o].getAttribute("id");
                    else if (t[o].hasAttribute("data-anchor-id"))
                        i = t[o].getAttribute("data-anchor-id");
                    else {
                        c = l = this.urlify(t[o].textContent),
                        s = 0;
                        do {
                            void 0 !== a && (c = l + "-" + s),
                            a = r.indexOf(c),
                    ...
                    "" === this.options.icon && (u.style.font = "1em/1 anchorjs-icons",
                    "left" === this.options.placement && (u.style.lineHeight = "inherit")),
                    "left" === this.options.placement ? (u.style.position = "absolute",
                    u.style.marginLeft = "-1em",
                    u.style.paddingRight = "0.5em",
                    t[o].insertBefore(u, t[o].firstChild)) : (u.style.paddingLeft = "0.375em",
                    t[o].appendChild(u))
                }
            for (o = 0; o < d.length; o++)
                t.splice(d[o] - o, 1);
            return this.elements = this.elements.concat(t),
            this
        }
        ,
        this.remove = function(e) {
            for (var t, n, r = A(e), i = 0; i < r.length; i++)
                (n = r[i].querySelector(".anchorjs-link")) && (-1 !== (t = this.elements.indexOf(r[i])) && this.elements.splice(t, 1),
                r[i].removeChild(n));
            return this
        }
        ,
        ...
        this.urlify = function(e) {
            ...
            e.trim().replace(/\'/gi, "").replace(t, "-").replace(/-{2,}/g, "-").substring(0, this.options.truncate).replace(/^-+|-+$/gm, "").toLowerCase()
        }
        ,
...
!function(i) {
    if (i.document) {
        ...
        o.querySelectorAll || (o.querySelectorAll = function(e) {
            var t, n = o.createElement("style"), r = [];
            for (o.documentElement.firstChild.appendChild(n),
            o._qsa = [],
            n.styleSheet.cssText = e + "{x-qsa:expression(document._qsa && document._qsa.push(this))}",
            i.scrollBy(0, 0),
            n.parentNode.removeChild(n); o._qsa.length; )
                t = o._qsa.shift(),
        ...
        function(e) {
            ...
            e.atob = e.atob || function(e) {
                ...
                for (; n < e.length; )
                    ...
                    i = i << 6 | t,
                    o += 6,
                    24 === o && (r.push(String.fromCharCode(i >> 16 & 255)),
        ...
        function() {
            if ("performance"in i == !1 && (i.performance = {}),
        ...
        (function(h) {
            ...
            function d(e, t) {
                ...
                2 === i.length) {
                    ...
                    if (n.auto = b.truthy(l.auto),
                    l.bg && (n.theme.bg = b.parseColor(l.bg)),
                    l.fg && (n.theme.fg = b.parseColor(l.fg)),
                    l.bg && !l.fg && (n.autoFg = !0),
                    l.theme && n.instanceOptions.themes.hasOwnProperty(l.theme) && (n.theme = E(n.instanceOptions.themes[l.theme], null)),
            ...
            function f(e) {
                ...
                !A.noFontFallback && "img" === n.nodeName.toLowerCase() && O.setup.supportsCanvas && "svg" === A.renderer && (A = E(A, {
                    renderer: "canvas"
                }))),
                ...
                "html" == A.renderer ? n.style.backgroundColor = a.bg : (m(g),
                "exact" == r.textmode && (n.holderData.resizeUpdate = !0,
                O.vars.resizableImages.push(n),
                v(n)))) : "background" == t && "html" != A.renderer ? m(g) : "fluid" == t && (n.holderData.resizeUpdate = !0,
                ...
                y(n),
                "html" == A.renderer ? n.style.backgroundColor = a.bg : (O.vars.resizableImages.push(n),
                v(n)))
            }
            function m(t) {
                function n() {
                ...
                "background" == r ? (i.style.backgroundImage = "url(" + e + ")",
                a.noBackgroundSize || (i.style.backgroundSize = s.width + "px " + s.height + "px")) : ("img" === i.nodeName.toLowerCase() ? x.setAttr(i, {
                    src: e
            ...
            function c(e) {
                ...
                if (p.lineCount > 1) {
                    ...
                    for (var x = 0; x < p.words.length; x++) {
                        ...
                        g = new s.Text(E.text);
                        var S = "\\n" == E.text;
                        !e.noWrap && (y + E.width >= o || S === !0) && (t(A, m, y, A.properties.leading),
                        A.add(m),
                        y = 0,
                        ...
                        m.y = b),
                        S !== !0 && (g.moveTo(y, 0),
                        y += p.spaceWidth + E.width,
                        m.add(g))
                    }
                    if (t(A, m, y, A.properties.leading),
                    A.add(m),
                    "left" === e.align)
                        ...
                        for (v in A.children)
                            m = A.children[v],
                            m.moveTo(e.width - m.width, null, null);
                    ...
                    m.add(g),
                    A.add(m),
                    "left" === e.align ? A.moveTo(e.width - i, null, null) : "right" === e.align ? A.moveTo(0 - (e.width - i), null, null) : A.moveTo((e.width - p.boundingBox.width) / 2, null, null),
            ...
            function r() {
                var t, n = [], e = Object.keys(O.vars.invisibleImages);
                e.forEach(function(e) {
                    t = O.vars.invisibleImages[e],
                    S(t) && "img" == t.nodeName.toLowerCase() && (n.push(t),
                    delete O.vars.invisibleImages[e])
                }),
                n.length && s.run({
                    images: n
                }),
            ...
            function e() {
                O.vars.visibilityCheckStarted || (h.requestAnimationFrame(r),
            ...
            var i = F(2)
              ...
              , s = {
                ...
                run: function(e) {
                    ...
                    O.setup.renderers.join(",").indexOf(c.renderer) === -1 && (c.renderer = O.setup.supportsSVG ? "svg" : O.setup.supportsCanvas ? "canvas" : "html");
            ...
            for (var l in O.flags)
                O.flags.hasOwnProperty(l) && (O.flags[l].match = function(e) {
            ...
            i && i(function() {
                ...
                h.addEventListener ? (h.addEventListener("resize", n, !1),
                h.addEventListener("orientationchange", n, !1)) : h.attachEvent("onresize", n),
                "object" == typeof h.Turbolinks && h.document.addEventListener("page:change", function() {
                    s.run()
                })
            }),
            L.exports = s
    ...
    , function(e, t, n) {
        (function(c) {
            ...
            t.initSVG = function(e, t, n) {
                var r, i, o = !1;
                e && e.querySelector ? (i = e.querySelector("style"),
                null === i && (o = !0)) : (e = u.newEl("svg", s),
                o = !0),
                o && (r = u.newEl("defs", s),
                i = u.newEl("style", s),
                u.setAttr(i, {
            ...
            t.serializeSVG = function(e, t) {
                if (c.XMLSerializer) {
                    ...
                    if (t.svgXMLStylesheet) {
                        ...
                        r = n.serializeToString(o)
                    }
                    var l = n.serializeToString(e);
                    return l = l.replace(/\&amp;(\#[0-9]{2,}\;)/g, "&$1"),
                    r + l
                }
            }
        }
    ...
    , function(e, t) {
        (function(n) {
            ...
            t.getNodeArray = function(e) {
                var t = null;
                return "string" == typeof e ? t = document.querySelectorAll(e) : n.NodeList && e instanceof n.NodeList ? t = e : n.Node && e instanceof n.Node ? t = [e] : n.HTMLCollection && e instanceof n.HTMLCollection ? t = e : e instanceof Array ? t = e : null === e && (t = []),
            ...
            for (; d < t.length; d++) {
                ...
                if (void 0 !== t[d] && t[d] !== !0)
                    if ("string" == typeof t[d])
                        ...
                        for (c in t[d])
                            t[d].hasOwnProperty(c) && null !== t[d][c] && t[d][c] !== !1 && ("style" === c && "object" == typeof t[d][c] ? t[0].attr[c] = JSON.stringify(t[d][c], i).slice(2, -2).replace(/","/g, ";").replace(/":"/g, ":").replace(/\\"/g, "'") : t[0].attr[c] = t[d][c])
                    }
            }
            if (t[0] !== !1) {
                l = "<" + t[0].tag;
    ...
    , function(e, t, n) {
        ...
        e.exports = function() {
            ...
            return function(e) {
                ...
                g.fillRect(0, 0, i, o),
                r.properties.outline && (g.strokeStyle = r.properties.outline.fill,
                ...
                g.font = l.properties.font.weight + " " + t * l.properties.font.size + l.properties.font.units + " " + l.properties.font.family + ", monospace",
...
(function(i) {
    ...
    i(function() {
        ...
        i("figure.highlight, div.highlight").each(function() {
            var e = '<div class="bd-clipboard"><button class="btn-clipboard" title="复制代码">复制</button></div>';
            i(this).before(e);
        ...
        e.on("success", function(e) {
            i(e.trigger).attr("title", "Copied!").tooltip("_fixTitle").tooltip("show").attr("title", "复制代码").tooltip("_fixTitle");
            e.clearSelection()
        });
        e.on("error", function(e) {
            var t = /Mac/i.test(navigator.userAgent) ? "⌘" : "Ctrl-";
            var n = "Press " + t + "C to copy";
            i(e.trigger).attr("title", n).tooltip("_fixTitle").tooltip("show").attr("title", "复制代码").tooltip("_fixTitle")
        });
        anchors.options = {
            icon: "#"
        };
